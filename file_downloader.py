...
class ProgressWindow:
    ...
    def __init__(self, parent):
        ...
        self.window.title("Descargador de adjuntos - Hospital Universitario del Valle")
    ...
    class DateRangeDialog:
        def __init__(self, parent):
            try:
                ...
                x = (self.top.winfo_screenwidth() // 2) - (540 // 2)
                y = (self.top.winfo_screenheight() // 2) - (370 // 2)
                self.top.geometry(f"540x370+{x}+{y}")
            ...
            content_frame.pack(pady=25, padx=35, fill='both', expand=True)
...
def process_emails(remitente, keyword, fecha_desde=None, fecha_hasta=None, parent_window=None):
    ...
    try:
        ...
        if downloaded_files:
            ...
            mensaje = f"No se encontraron archivos nuevos con {keyword} para descargar.\n\n"
            mensaje += f"Mensajes revisados: {total_messages}\n"
...
if __name__ == "__main__":
    ...
    root = tk.Tk()
    root.title("Descargador de adjuntos - HUV")
    ...
    try:
        logging.info("="*60)
        logging.info("INICIANDO DESCARGADOR DE ADJUNTOS - HUV")
        logging.info("="*60)
        ...
        messagebox.showinfo(
            "Descargador de ADJUNTOS - HUV",
            "Bienvenido al descargador automático de archivos ADJUNTOS\n\n"
